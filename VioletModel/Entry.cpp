...
#if _M_ARM64
#pragma comment(lib, R"(Bass\bass_arm64.lib)")
#pragma comment(lib, R"(Bass\bass_fx_arm64.lib)")
#pragma comment(lib, R"(Bass\bassmidi_arm64.lib)")
#elif defined _WIN64
...
//#endif
	...
	pWnd->Create(L"VioletPlayer", WS_POPUP | WS_VISIBLE | WS_CAPTION |

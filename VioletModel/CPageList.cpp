...
HRESULT CPageList::OnMenuAddFile(CPlayList* pList, int idxInsert)
{
    ...
    if (FAILED(hr))
        return hr;
    pfod->SetTitle(m_AppLang.LANG_ID_PLAYLIST_ADDFILE);
...
LRESULT CPageList::OnEvent(UINT uMsg, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_SIZE:
        ...
        CheckVisibleItemMetaData(-1);
        //ListWidth = m_GLList.GetWidthF();
        m_GLList.SetHeaderItemWidth(0, m_GLList.GetWidthF() / 2);
        m_GLList.SetHeaderItemWidth(1, (m_GLList.GetWidthF() / 2 - 60) / 2);
        m_GLList.SetHeaderItemWidth(2, (m_GLList.GetWidthF() / 2 - 60) / 2);
        m_GLList.SetHeaderItemWidth(3, 60);
        break;
    ...
    case WM_CREATE:
    {
        ...
        UpdateDefCover();
        {
            ...
            m_EDSearch.setCueBanner(m_AppLang.LANG_ID_PLAYLIST_SEARCHLIST);
        ...
        m_Lyt.Add(&m_LytPlayList, { .cxRightWidth = (int)CxPageIntPadding, .cyTopHeight = (int)(CyPageTitle + DTopPageTitle + CxPageIntPadding) },
...

        {
            ...
            m_GLList.Create(nullptr, Dui::DES_VISIBLE | Dui::DES_CONTENT_EXPAND, 0,
                0, 0, 0, 0, this);

            m_LATopBarSpacer.Create(L" ", Dui::DES_VISIBLE, 0, 0, 0, 400, CyStdEdit + CyPageTitle + DTopPageTitle + CxPageIntPadding, this, GetWnd());

            m_BTAddFile.Create(m_AppLang.LANG_ID_PLAYLIST_ADDFILE, Dui::DES_VISIBLE | Dui::DES_CONTENT_EXPAND, 0,
            ...
            m_BTLocate.showBorder(true);
            m_BTLocate.blurBkg(true);
            m_BTLocate.setImgPadding(8.f);
            ...
            m_EDSearchItem.Create(nullptr, Dui::DES_VISIBLE | Dui::DES_CONTENT_EXPAND, 0,
            ...
            m_LytList.Add(&m_LytTopBar, { .cyTopHeight = (int)-(CyStdEdit + CxPageIntPadding), .cyBottomHeight = (int)CxPageIntPadding},
                eck::LF_FIX_HEIGHT | eck::LF_FILL_WIDTH);

            /*
            m_LytList.Add(&m_LytTopBar, { .cyTopHeight = (int)(CyPageTitle + DTopPageTitle + CxPageIntPadding), .cyBottomHeight = (int)CxPageIntPadding},
                eck::LF_FIX_HEIGHT | eck::LF_FILL_WIDTH);
            */
            ...
            m_GLList.SetView(CVeListTemplate::Type::Report);
            constexpr float Width[]{ 270, 150, 150, 50 };
            m_GLList.SetHeaderVisible(false);

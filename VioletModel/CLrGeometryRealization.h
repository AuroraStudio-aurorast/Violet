...
private:
    ...
    float m_cxEmptyText{};
    float m_cyEmptyText{};
    D2D1_RECT_F m_rectCurr{};
    D2D1_RECT_F m_rectOld{};
...
public:
    ...
    void LrItmDraw(const LRD_DRAW& Opt, int curr) override;
    HRESULT LrUpdateEmptyText(const LRD_EMTRY_TEXT& Opt) override;
    void LrSetViewSize(float cx, float cy) override;
    void LrUpdateFadeBrush();
    void LrSetCurrentItemRect(D2D1_RECT_F rectCurr) override;
